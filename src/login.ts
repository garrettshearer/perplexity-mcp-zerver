...
async function setupBrowserEvasion(page: import("puppeteer").Page) {
    await page.evaluateOnNewDocument(() => {
        ...
        // T002: Use proper type assertion via Object.assign instead of (window as any).chrome
        // This satisfies TypeScript's global Window.chrome declaration from browser.ts
